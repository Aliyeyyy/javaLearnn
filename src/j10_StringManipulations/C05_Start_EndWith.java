...
public class C05_Start_EndWith {
    public static void main(String[] args) {
        ...
        System.out.println("gmail hesabinizi giriniz");
        String gmail= scanner.nextLine();
        if (gmail.contains("gmail.com")) {
            if (gmail.endsWith("gmail.com")) {
                System.out.println("hesabiniz onaylandı");
            }else System.out.println("lutfen gecerli bir gmail hesabi giriniz");
        }
        else System.out.println("lutfen bir gmail hesabi giriniz");
