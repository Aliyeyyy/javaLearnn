...
public class C06_SwitchClase {
    public static void main(String[] args) {

        // girilen haftanın gününü hafta içi veya sonu oldugunu print eden code create ediniz
        ...
        switch(gun) {
            ...
            case "salı":
            case "çarşamba":
            case "perşembe": // yukarıdaki tüm case ler aynı aksiyonu vereceği i.in break yazılmadı
            case "cuma":
            ...
            default: //switch hiç bir case ile eşleşmezse çalışır
